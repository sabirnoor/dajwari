				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="home">
						<div class="row">
							...
							<?php 
							if($getBrowseProductsList){
								foreach($getBrowseProductsList as $val){
									$val = (array) $val;
									$p_color = getProductColorDetails($val['id']);
									$p_image = getProductImageDetails($val['id']);
							...
							?>
								<div class="col-md-4 col-sm-4 col-xs-12">
									<div class="single-product">
										...
										<h4 class="name"><a href="#"><?=text_limit($val['p_name'],35)?></a></h4>
										<span class="amount">
